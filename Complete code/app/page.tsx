...
const Footer = () => (
  <footer className="w-full border-t border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-14 flex items-center">
    <div className="container flex max-w-4xl items-center justify-between mx-auto text-sm">
      <p className="text-muted-foreground">Built with Next.js and Gemini</p>
      <p className="text-muted-foreground">© 2024 Your Name</p>
    </div>
  </footer>
);
